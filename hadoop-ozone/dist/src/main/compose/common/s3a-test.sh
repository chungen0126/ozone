...
EOF
  ...
  mvn -B -V --fail-never --no-transfer-progress \
    -Dtest='ITestS3AContract*, ITestS3ACommitterMRJob, !ITestS3AContractBulkDelete, !ITestS3AContractCreate#testOverwrite*EmptyDirectory[*], !ITestS3AContractDistCp, !ITestS3AContractRename' \
    clean test
