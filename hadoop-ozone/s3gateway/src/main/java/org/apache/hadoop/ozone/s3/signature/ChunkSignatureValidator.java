...
public class ChunkSignatureValidator {
  ...
  private String buildChunkStringToSign(String chunkPayloadHash) {
    ...
    stringToSign.append("AWS4-HMAC-SHA256-PAYLOAD").append(NEWLINE)
        .append(signatureInfo.getDateTime()).append(NEWLINE)
        .append(signatureInfo.getCredentialScope()).append(NEWLINE)
        .append(previousSignature).append(NEWLINE)
        .append(EMPTY_STRING_HASH).append(NEWLINE)
        .append(chunkPayloadHash);
